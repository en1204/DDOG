...
def convert_wikihop_to_uniform_format(example):
...
def convert_cwq_to_uniform_format(example):
...
UNIFORM_FORMAT_MAP = {
    ...
    "wikihop": convert_wikihopqa_to_uniform_format, 
    "cwq": convert_cwq_to_uniform_format, 
}

DATASET_TRAIN_DEV_FILES = {
    "hotpotqa": {"train": "hotpot_train_v1.1.json", "dev": "hotpot_dev_distractor_v1.json"}, 
    "wikihop": {"train": "train.json", "dev": "dev.json"}, 
    "cwq": {"train": "cwq_ans_v1.0_train.jsonl", "dev": "cwq_ans_v1.0_dev.jsonl"}, 
}
